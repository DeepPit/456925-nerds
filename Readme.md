...
* Студент: [Валерий Анисимов](https://up.htmlacademy.ru/htmlcss/22/user/456925).
* Наставник: `no master`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/456925-nerds) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
